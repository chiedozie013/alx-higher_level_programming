File 0 - Write a script that prints “JavaScript is amazing”:
...
File 5 - Write a script that prints My number: <first argument converted in integer> if the first argument can be converted to an integer:
